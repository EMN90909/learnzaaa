...
const HeroSection: React.FC = () => {
  return (
    <section className="py-20 px-4 text-center bg-gradient-to-br from-blue-50 to-green-50 dark:from-black dark:to-gray-900">
      <div className="container mx-auto max-w-4xl">
        <div className="mb-8">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight dark:text-white">
            <span className="text-blue-600 dark:text-blue-400">Learnzaaac</span> – Fun Learning for Kids
          </h1>
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div className="w-64 h-64 bg-gradient-to-br from-blue-200 to-green-200 dark:from-blue-900 dark:to-green-900 rounded-full flex items-center justify-center shadow-lg">
              <div className="text-center">
                ...
                <p className="text-lg font-semibold text-gray-800 dark:text-white">Learning Made Fun!</p>
              </div>
            </div>
          </div>
        </div>
