...
import { Upload, FileText, Image as ImageIcon, File as FilePdf, Loader2, Lightbulb, Copy, Check, AlertCircle, Files, X, Camera, GraduationCap, PartyPopper } from 'lucide-react';
